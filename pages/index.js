...
import { ArrowDownAZ as LucideArrowDownAZ, ArrowDownZA as LucideArrowDownZA, ChevronLeft as LucideChevronLeft, ChevronRight as LucideChevronRight, ChevronsLeft as LucideChevronsLeft, ChevronsLeftRightEllipsis as LucideChevronsLeftRightEllipsis, ChevronsRight as LucideChevronsRight, Group as LucideGroup, Hash as LucideHash, Layers2 as LucideLayers2, Linkedin as LucideLinkedin, LocateFixed as LucideLocateFixed, Map as LucideMap, MessageSquare as LucideMessageSquare, Moon as LucideMoon, Plane as LucidePlane, PlaneTakeoff as LucidePlaneTakeoff, Ruler as LucideRuler, Search as LucideSearch, Sun as LucideSun, Table2 as LucideTable2, Twitter as LucideTwitter, X as LucideX, Youtube as LucideYoutube } from "lucide-react"
...
export function Table__body_eec7cd788e28fa6135879a02342e15fe () {
...
{
    (() => {
        switch (JSON.stringify(player["type"])) {
                case JSON.stringify("Multirole"):
                return <RadixThemesBadge color={"purple"} radius={"large"} size={"3"} variant={"surface"}>

{"Multirole"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("Training"):
                return <RadixThemesBadge color={"orange"} radius={"large"} size={"3"} variant={"surface"}>

{"Training"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("SAR"):
                return <RadixThemesBadge color={"lime"} radius={"large"} size={"3"} variant={"surface"}>

{"SAR"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("AWACS"):
                return <RadixThemesBadge color={"iris"} radius={"large"} size={"3"} variant={"surface"}>

{"AWACS"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("Attack"):
                return <RadixThemesBadge color={"red"} radius={"large"} size={"3"} variant={"surface"}>

{"Attack"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("Conversion"):
                return <RadixThemesBadge color={"crimson"} radius={"large"} size={"3"} variant={"surface"}>

{"Conversion"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("Military Support"):
                return <RadixThemesBadge color={"green"} radius={"large"} size={"3"} variant={"surface"}>

{"Military Support"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("EW"):
                return <RadixThemesBadge color={"cyan"} radius={"large"} size={"3"} variant={"surface"}>

{"EW"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("Transport"):
                return <RadixThemesBadge color={"yellow"} radius={"large"} size={"3"} variant={"surface"}>

{"Transport"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("Tankers"):
                return <RadixThemesBadge color={"blue"} radius={"large"} size={"3"} variant={"surface"}>

{"Tankers"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("VIP & Transport"):
                return <RadixThemesBadge color={"gold"} radius={"large"} size={"3"} variant={"surface"}>

{"VIP & Transport"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("Interceptor"):
                return <RadixThemesBadge color={"ruby"} radius={"large"} size={"3"} variant={"surface"}>

{"Interceptor"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("Composite AAv"):
                return <RadixThemesBadge color={"gold"} radius={"large"} size={"3"} variant={"surface"}>

{"Composite AAv"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("Army Aviation"):
                return <RadixThemesBadge color={"blue"} radius={"large"} size={"3"} variant={"surface"}>

{"Army Aviation"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("Anti-submarine"):
                return <RadixThemesBadge color={"indigo"} radius={"large"} size={"3"} variant={"surface"}>

{"Anti-submarine"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("Anti-submarine & EW"):
                return <RadixThemesBadge color={"blue"} radius={"large"} size={"3"} variant={"surface"}>

{"Anti-submarine & EW"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("UAV"):
                return <RadixThemesBadge color={"lime"} radius={"large"} size={"3"} variant={"surface"}>

{"UAV"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("Maritime Surveillance"):
                return <RadixThemesBadge color={"indigo"} radius={"large"} size={"3"} variant={"surface"}>

{"Maritime Surveillance"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("ISR"):
                return <RadixThemesBadge color={"orange"} radius={"large"} size={"3"} variant={"surface"}>

{"ISR"}
</RadixThemesBadge>;
                break;
                case JSON.stringify("Unknown"):
                return <RadixThemesBadge color={"tomato"} radius={"large"} size={"3"} variant={"surface"}>
...
<RadixThemesLink asChild={true} css={({ ["&:hover"] : ({ ["color"] : "var(--accent-8)" }) })} size={"5"} target={(true ? "_blank" : "")}>

<NextLink href={player["url"]} passHref={true}>

<RadixThemesButton css={({ ["@media screen and (min-width: 0)"] : ({ ["width"] : "6rem", ["fontSize"] : "0.5em", ["padding"] : "1em" }), ["@media screen and (min-width: 30em)"] : ({ ["width"] : "6rem", ["fontSize"] : "0.5em", ["padding"] : "1em" }), ["@media screen and (min-width: 48em)"] : ({ ["width"] : "7rem", ["fontSize"] : "0.7em", ["padding"] : "0em" }) })} size={"2"}>
...
export function Select__root_318dc46ebfdf600b5ba67158b5e4e8d9 () {
...
{""}
<RadixThemesSelect.Item value={"Unit"}>

{"Unit"}
</RadixThemesSelect.Item>
<RadixThemesSelect.Item value={"Type"}>

{"Type"}
</RadixThemesSelect.Item>
<RadixThemesSelect.Item value={"Runways"}>

{"Runways"}
</RadixThemesSelect.Item>
<RadixThemesSelect.Item value={"Length"}>
...
<img css={({ ["height"] : "38px" })} src={"/pakistan.png"}/>
...
<Select__root_318dc46ebfdf600b5ba67158b5e4e8d9/>
...
<LucideGroup css={({ ["color"] : "var(--current-color)" })} size={18}/>
...
<LucideLocateFixed css={({ ["color"] : "var(--current-color)" })} size={18}/>
<RadixThemesText as={"p"}>
...
<LucideChevronsLeftRightEllipsis css={({ ["color"] : "var(--current-color)" })} size={18}/>
<RadixThemesText as={"p"}>
...
<LucideLayers2 css={({ ["color"] : "var(--current-color)" })} size={18}/>
<RadixThemesText as={"p"}>
...
<LucidePlaneTakeoff css={({ ["color"] : "var(--current-color)" })} size={18}/>
<RadixThemesText as={"p"}>
...
<LucideRuler css={({ ["color"] : "var(--current-color)" })} size={18}/>
<RadixThemesText as={"p"}>
...
<LucideMap css={({ ["color"] : "var(--current-color)" })} size={18}/>
<RadixThemesText as={"p"}>
...
<Table__body_eec7cd788e28fa6135879a02342e15fe/>
...
<meta content={"A registry containing information of Pakistani Airforce Orbat."} name={"description"}/>
